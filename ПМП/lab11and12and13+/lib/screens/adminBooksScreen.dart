...
class AdminBooksScreen extends StatelessWidget {
      ...
      floatingActionButton: BlocBuilder<AppBloc, AppState>(
        builder: (context, state) {
          ...
          return FloatingActionButton(
            key: const Key('admin_add_book_fab'),
            onPressed: () {
  ...
  void _showAddBookDialog(BuildContext context) {
    ...
    final coverColorController = TextEditingController(text: Book.defaultCoverColor);
        ...
        builder: (context, setState) => AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                TextField(
                  key: const Key('admin_book_title_field'),
                ...
                TextField(
                  key: const Key('admin_book_author_field'),
                ...
                const SizedBox(height: 12),
                TextField(
                  key: const Key('admin_book_description_field'),
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Цвет обложки',
                    hintText: 'Например: 0xFFd0c9b7 или Color(0xFFd0c9b7)',
                  ),
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: ColorParser.fromString(coverColorController.text),
                    ),
                  ),
                ),
                const SizedBox(height: 12),
          ...
          actions: [
            ...
            ElevatedButton(
              key: const Key('admin_add_book_button'),
              onPressed: () {
                ...
                if (title.isNotEmpty && author.isNotEmpty) {
                  ...
                  final normalizedColor = _normalizeColorInput(coverColorController.text);
  ...
  void _showEditBookDialog(BuildContext context, Book book) {
    ...
    final coverColorController = TextEditingController(text: book.coverColor);
  ...
  String _normalizeColorInput(String raw) {
    final color = ColorParser.fromString(raw);
